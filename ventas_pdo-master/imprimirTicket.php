...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.id, p.Nombreproducto,p.Preciounidad, pv.cantidad
FROM productos p
INNER JOIN 
        ...
        <table>
            ...
            <tbody>
                ...
                foreach ($productos as $producto) {
                    $subtotal = $producto->Preciounidad * $producto->cantidad;
                    $total += $subtotal;
                ?>
                    <tr>
                        <td class="cantidad"><?php echo $producto->cantidad;  ?></td>
                        <td class="producto"><?php echo $producto->Nombreproducto;  ?> <strong>$<?php echo number_format($producto->Preciounidad, 2) ?></strong></td>
